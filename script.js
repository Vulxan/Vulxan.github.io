...
var Canvas = (function() {
  function Canvas(_ref) {
    ...
    this.addEntity = function(newEntity) {
      _this.entities = [].concat(toConsumableArray(_this.entities), [
        newEntity
      ]);
...
var PointPhysics = (function(_Point) {
  ...
  function PointPhysics(_ref) {
    var x = _ref.x,
      ...
      pointerStrength =
        _ref$pointerStrength === undefined ? 0.25 : _ref$pointerStrength,
      _ref$pointerRadius = _ref.pointerRadius,
      pointerRadius =
        _ref$pointerRadius === undefined ? 100 : _ref$pointerRadius;
    classCallCheck(this, PointPhysics);

    var _this = possibleConstructorReturn(
      this,
      (PointPhysics.__proto__ || Object.getPrototypeOf(PointPhysics)).call(
        this,
        x,
        y
      )
...
var Spring = (function(_Point) {
  ...
  function Spring(_ref) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Spring.__proto__ || Object.getPrototypeOf(Spring)).call(this, x, y)
    );
  ...
  createClass(Spring, [
    ...
    },
    {
      ...
      value: function addAttractor(point) {
        this.attractors = [].concat(toConsumableArray(this.attractors), [
          point
        ]);
      }
    },
...
class Matrix {
  constructor() {
    _defineProperty(
      ...
      context => this.createMatrix(context)
    );
    _defineProperty(
      this,
      'resize',
